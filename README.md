...
`xcode-select --install` to get GCC. On Windows you will need to use
`pip install magic-wormhole[windows]` to install the extra required
libraries. (Note: only python2 is supported on windows at this time).
